        ...
        try {
            ...
            ApiService.call('post', uri + "/" + device._id, params, (content) => {
                ...
                if (content.report_data.length == 0) {
                    alert("No stopage data available..")
                }
            ...
            <View style={{ backgroundColor: 'white', flex: 1 }}>
                    ...
                    <View>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-around', marginTop: 10, paddingHorizontal: 5 }}>
                            <View style={{ justifyContent: 'center', alignItems: 'center', width: '33%' }}>
                                ...
                                <Text style={{ fontSize: 12, color: 'black', fontWeight: 'bold' }}>{deviceDetails.engine_on_time|| "--"}</Text>
                                <Text style={{ fontSize: 12,fontWeight: 'bold' }}>Moving</Text>
                            </View>
                            <View style={{ justifyContent: 'center', alignItems: 'center', width: '33%' }}>
                                <RoadIcon name="road" size={24} />
                                <Text style={{ fontSize: 12, color: 'black', fontWeight: 'bold' }}>{deviceDetails.total_distance|| "--"} KMS</Text>
                                <Text style={{ fontSize: 12,fontWeight: 'bold' }}>Travelled</Text>
                            </View>

                            <View style={{ justifyContent: 'center', alignItems: 'center', width: '33%' }}>
                                <BedIcon name="bed" size={24} color='red' />
                                <Text style={{ fontSize: 12, color: 'black', fontWeight: 'bold' }}>{deviceDetails.stoppage_time|| "--"}</Text>
                ...
                <View style={{ flex: 1 }} />
                {
                    ...
                    <FlatList data={report_data}
                        ...
                        renderItem={({ item, index }) => {
                            return (
                                <TouchableOpacity activeOpacity={0.70} onPress={() => NavigationService.navigate('homeStack', 'MapView', { device: device, record: item, type: "stoppage", screen: "stoppage" })}
