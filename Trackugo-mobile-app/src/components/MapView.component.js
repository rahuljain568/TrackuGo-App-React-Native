...
export default class MapViewComponent extends Component {
  ...
  componentDidMount() {
    ...
    let { navigation } = this.props,
      notification = navigation.getParam('record', null),
      screen_name = navigation.getParam('screen', null);
  ...
  render() {
    ...
    let { notification, location, mapType, screen_name } = this.state;
              ...
              <Callout>
                <View style={notificationStyle.callout}>
                  ...
                  <View style={notificationStyle.calloutRow}>
                    ...
                    >
                      {moment
                        .utc(notification.start_time, "YYYY-MM-DD HH:mm:ss")
                        .local()
                        .fromNow()}
                    </Text>
                  </View>
