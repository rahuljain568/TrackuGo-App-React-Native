...
export default class ActiveTab extends Component {
  ...
  async componentDidMount() {
    try {
      ...
      console.log("LocationTracking Enabled");
      BackgroundGeolocation.configure({
        ...
        syncUrl: `http://api-staging.trackugo.in/user/location/update`,
        syncThreshold: 100,
        httpHeaders: {
      ...
      BackgroundGeolocation.on("location", (location) => {
        ...
        BackgroundGeolocation.startTask((taskKey) => {
          requestAnimationFrame(() => {
            ...
            this.setState({ locations, region, location: my_location, current_address: address });
            console.log("Location", this.state.region, this.state.locations, this.state.location)
        ...
        BackgroundGeolocation.startTask((taskKey) => {
          requestAnimationFrame(() => {
            ...
            if (location.radius) {
              ...
              this.setState({ stationaries, region, location: my_location, current_address: address });
              console.log("Location", this.state.stationaries, this.state.region, this.state.locations, this.state.location)
            }
            BackgroundGeolocation.endTask(taskKey);
          });
        });
    ...
    try {
      ...
      BackgroundGeolocation.getCurrentLocation(
        async (lastLocation) => {
          ...
          address = address ? address : 'Not Available';
          console.log("Current Address", address);
          console.log('lastLocation.latitude', lastLocation.latitude);
          console.log('lastLocation.longitude', lastLocation.longitude);
          this.setState({
  ...
  async shareMyLocation(user) {
    try {
      let lat = user.location.coordinates[0];
      let lon = user.location.coordinates[1];
